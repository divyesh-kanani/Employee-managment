...
const AcceptTask = ({data}) => {
    ...
    return (
        <div className='scrollbarhide w-52 h-56  bg-[#ad54fa] rounded-md flex-shrink-0 p-2 overflow-auto'>
            ...
            <div className='flex justify-between pt-2 pl-8 '>
                <button className='bg-[#f37a7a] text-white px-2 rounded-md hover:bg-purple-700'>Complete</button>
                <button className='bg-[#f37a7a] text-white px-2  rounded-md hover:bg-purple-700'>Fail</button>
            </div>
