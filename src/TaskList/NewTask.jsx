...
const NewTask = ({data}) => {
    return (
        <div className='scrollbarhide w-52 h-56  bg-[#c28adb] rounded-md flex-shrink-0 p-2 overflow-auto'>
         ...
         text-[#2c1d75]'>
            ...
            <div className='flex justify-between pt-2 pl-[6.5rem] '>
                ...
                <button className='bg-[#f37a7a] text-white px-2  rounded-md hover:bg-purple-700'>Acceept</button>
            </div>
